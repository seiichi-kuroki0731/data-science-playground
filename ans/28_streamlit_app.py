...
Colorbar changes in matplotlib>3.4.3 introduced bugs (#22625, #22087) that cause the colorbar of certain shap plots (e.g. beeswarm) to not display properly.
...
with st.expander("Force plot"):
    ...
    st_shap(
        shap.force_plot(
            explainer.expected_value, shap_values[0, :], X_display.iloc[0, :]
        ),
        height=200,
        width=1000,
    )
